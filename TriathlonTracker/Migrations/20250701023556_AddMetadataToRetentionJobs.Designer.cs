...
namespace TriathlonTracker.Migrations
{
    ...
    [Migration("20250701023556_AddMetadataToRetentionJobs")]
    partial class AddMetadataToRetentionJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TriathlonTracker.Models.DataArchive", b =>
                {
                    ...
                    b.Property<string>("StringMetadataJson")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("StringMetadata");
